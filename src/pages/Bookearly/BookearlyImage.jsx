...
const BookearlyImage = () => {
    ...
    return <Link to="/bookearly"><div  className=" rounded-xl relative bg-cover bg-no-repeat m-auto bg-center my-[30px] w-[90%] h-[300px]" style={{backgroundImage: "url(https://a.travel-assets.com/travel-assets-manager/gmvd-1482-bookearly-emea/667x320.jpg)"}}>
